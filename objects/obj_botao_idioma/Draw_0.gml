...
var _id = (idioma == global.idioma)
draw_sprite_ext(spr_select, 0, x-cube_x, y, tam, tam, 0, c_white, ativo);
draw_sprite_ext(spr_capa, 0, x, y, tam+.3, tam+.3, 0, c_blue, _id);
draw_sprite_ext(spr_idioma, idioma, x, y, tam, tam, 0, c_white, 1);
